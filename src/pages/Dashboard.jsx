...
function Dashboard() {
    const { tasks, habits, sessions } = useUser(); // Centralized state
    ...
    return (
        <div className="dashboard-page">
            ...
            <div className="dashboard-grid-top">
                ...
                <ProgressCard label="Tasks" completed={completedTasks} total={totalTasks} color="#378ADD" />
                <ProgressCard label="Habits" completed={completedHabits} total={totalHabits} color="#38a169" />
